...
var _marked = [getTokenFromCode, getTokenFromRefreshToken, performTokenRefresh, tokenRefreshLoop, headlessCasLoginFlow, casLoginFlow, shibLoginFlow, localLoginFlow, facebookLoginFlow, handleAuthFailure, authSaga].map(_regenerator2.default.mark);
			...
			switch (_context11.prev = _context11.next) {
				...
				case 53:
					...
					return (0, _effects.all)({
						...
						refreshLoop: (0, _effects.call)(tokenRefreshLoop),
						persistToken: (0, _effects.call)(tokenPersistenceService.persistToken, oauthToken),
				...
				case 60:
					...
					return (0, _effects.all)({
						...
						clearAuthData: (0, _effects.put)((0, _actions.createAction)(_studiokitNetJs.actions.KEY_REMOVAL_REQUESTED, { modelName: 'auth' })),

	...
	return _regenerator2.default.wrap(function casLoginFlow$(_context) {
		while (1) {
			switch (_context.prev = _context.next) {
				case 0:
					return _context.abrupt('return', 'tokenViaCas');
	...
	return _regenerator2.default.wrap(function shibLoginFlow$(_context2) {
		while (1) {
			switch (_context2.prev = _context2.next) {
				case 0:
					return _context2.abrupt('return', 'tokenViaShib');
	...
	return _regenerator2.default.wrap(function localLoginFlow$(_context3) {
		while (1) {
			switch (_context3.prev = _context3.next) {
				case 0:
					return _context3.abrupt('return', 'tokenViaLocal');
	...
	return _regenerator2.default.wrap(function facebookLoginFlow$(_context4) {
		while (1) {
			switch (_context4.prev = _context4.next) {
				case 0:
					return _context4.abrupt('return', 'noFreakingClue');
			...
			switch (_context5.prev = _context5.next) {
				...
				case 38:
					...
					return (0, _effects.all)({
						storeToken: (0, _effects.put)((0, _actions.createAction)(_actions2.default.STORE_TOKEN, { token: token })),
						persistToken: (0, _effects.call)(_services.auth.persistToken, token)
					});

				case 40:
					_context5.next = 42;
					return (0, _effects.all)({
						loginSuccess: (0, _effects.put)((0, _actions.createAction)(_actions2.default.LOGIN_SUCCESS)),
						logOut: (0, _effects.take)(_actions2.default.LOG_OUT)
					});

				case 42:
					_context5.next = 44;
					return (0, _effects.all)({
						deleteToken: (0, _effects.put)((0, _actions.createAction)(_actions2.default.DELETE_TOKEN)),
						deletePersistedToken: (0, _effects.call)(_services.auth.persistToken, null)
					});

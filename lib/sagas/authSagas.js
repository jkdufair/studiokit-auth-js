	...
	return _regenerator2.default.wrap(function getTokenFromRefreshToken$(_context2) {
		while (1) {
			switch (_context2.prev = _context2.next) {
				...
				case 17:
					_context2.next = 19;
					return (0, _effects.call)(_services.tokenPersistenceService.persistToken, refreshedToken);
...
function auth(clientCredentialsParam) {
	...
	var localTokenPersistenceService, _ref2, headlessCasAction, casAction, shibAction, localAction, facebookAction;
